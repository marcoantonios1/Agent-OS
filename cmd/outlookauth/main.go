// outlookauth is a one-time helper that uses the OAuth2 device code flow to
// obtain a refresh token for your Outlook account.
//
...
// Usage:
//
//	OUTLOOK_CLIENT_ID=<id> go run ./cmd/outlookauth/
package main
...
func main() {
	...
	if clientID == "" {
		log.Fatal("Set OUTLOOK_CLIENT_ID before running this tool.")
	}
	...
	fmt.Println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	fmt.Println("  Outlook OAuth2 Setup — Device Code Flow")
	fmt.Println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	fmt.Println()
	...
	fmt.Printf("     %s\n", deviceAuth.UserCode)
	fmt.Println()
	fmt.Println("3. Sign in with marco_antonios1@outlook.com and click Accept.")
	fmt.Println()
	...
	fmt.Println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	fmt.Println()
	fmt.Printf("OUTLOOK_CLIENT_ID=%s\n", clientID)
	fmt.Printf("OUTLOOK_REFRESH_TOKEN=%s\n", token.RefreshToken)
	fmt.Println()
	fmt.Println("No client secret needed with device code flow.")
	fmt.Println("Keep the refresh token secret — it grants read/draft access to your Outlook.")
}
